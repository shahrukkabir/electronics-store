          ...
          <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-12">
            <div>
              ...
              <p className="text-gray-400 max-w-sm">
                সুলভ মূল্যে বিভিন্ন ইলেকট ্রনিক্স ও গ্যাজেট  পণ্য। ওয়াকিট কি, রাইস কুকার, ব্লেন্ডার, আয়রন, ট ্রিমার, ফ্যান, রাউট ারসহ আরও অনেক কিছু।
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-6">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.1, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  className="w-10 h-10 rounded-full cursor-pointer bg-gray-700 hover:bg-blue-600 flex items-center justify-center transition-all duration-300 group"
                  aria-label="Scroll to top"
                >
                  <FiArrowUp className="w-5 h-5 text-gray-400 group-hover:text-white transition-colors" />
                </motion.a>
              </div>
            </div>
          </div>
